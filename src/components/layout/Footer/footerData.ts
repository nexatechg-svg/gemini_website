...
export const FOOTER_DATA = {
  ...
  sections: [
    ...
    },
    {
      ...
      contact: [
        ...
        {
          icon: FaEnvelope,
          label: "sales@gemininexatech.com",
          href: "mailto:sales@gemininexatech.com",
        },
        {
          icon: FaMapMarkerAlt,
          label:
            "Campus-1a, MILLENIA BUSINESS PARK-I, Perungudi, Chennai, Tamil Nadu 600096",
          href: "https://www.google.com/maps/search/?api=1&query=Campus-1a,+MILLENIA+BUSINESS+PARK-I,+Perungudi,+Chennai,+Tamil+Nadu+600096",
        },
        {
          icon: FaWhatsapp,
  ...
  socials: [
    {
      icon: FaLinkedin,
      href: "https://www.linkedin.com/company/gemininexatech",
      label: "LinkedIn",
      color: "#0A66C2",
    },
    {
      icon: FaTwitter,
      href: "https://x.com/gemininexatech",
      label: "Twitter",
      color: "#1DA1F2",
    },
    {
      icon: FaFacebook,
      href: "https://www.facebook.com/gemininexatech",
      label: "Facebook",
      color: "#ffffff",
    },
    {
      icon: FaInstagram,
      href: "https://www.instagram.com/gemininexatech",
      label: "Instagram",
      color: "#E4405F",
    },
  ],
